...
ushort intel_subgroup_block_read_u16_m1k16(const __global void *base_address, int width, int height, int pitch,
                                           int2 coord) {
  return __builtin_IB_subgroup_block_read_flat_u16_m1k16v1(as_long(base_address), width - 1, height - 1, pitch - 1,
                                                           coord);
}
ushort2 intel_subgroup_block_read_u16_m2k16(const __global void *base_address, int width, int height, int pitch,
                                            int2 coord) {
  return __builtin_IB_subgroup_block_read_flat_u16_m2k16v1(as_long(base_address), width - 1, height - 1, pitch - 1,
                                                           coord);
}
ushort4 intel_subgroup_block_read_u16_m4k16(const __global void *base_address, int width, int height, int pitch,
                                            int2 coord) {
  return __builtin_IB_subgroup_block_read_flat_u16_m4k16v1(as_long(base_address), width - 1, height - 1, pitch - 1,
                                                           coord);
}
ushort8 intel_subgroup_block_read_u16_m8k16(const __global void *base_address, int width, int height, int pitch,
                                            int2 coord) {
  return __builtin_IB_subgroup_block_read_flat_u16_m8k16v1(as_long(base_address), width - 1, height - 1, pitch - 1,
                                                           coord);
}
ushort16 intel_subgroup_block_read_u16_m16k16(const __global void *base_address, int width, int height, int pitch,
                                              int2 coord) {
  return __builtin_IB_subgroup_block_read_flat_u16_m16k16v1(as_long(base_address), width - 1, height - 1, pitch - 1,
                                                            coord);
}

__kernel void subgroup_block_read_u16_m1k16(__global int *a, __global int *out, int W, int H, int P) {
  ushort b = intel_subgroup_block_read_u16_m1k16(a, W, H, P, (int2)(0, 0));
};

__kernel void subgroup_block_read_u16_m2k16(__global int *a, __global int *out, int W, int H, int P) {
  ushort2 b = intel_subgroup_block_read_u16_m2k16(a, W, H, P, (int2)(0, 0));
};

__kernel void subgroup_block_read_u16_m4k16(__global int *a, __global int *out, int W, int H, int P) {
  ushort4 b = intel_subgroup_block_read_u16_m4k16(a, W, H, P, (int2)(0, 0));
};

__kernel void subgroup_block_read_u16_m8k16(__global int *a, __global int *out, int W, int H, int P) {
  ushort8 b = intel_subgroup_block_read_u16_m8k16(a, W, H, P, (int2)(0, 0));
};

__kernel void subgroup_block_read_u16_m16k16(__global int *a, __global int *out, int W, int H, int P) {
